      ...
      <div class="row w-125 h-100" v-if="!showMobileMap">
        <div class="col-lg-7 col-xl-7 col-md-7 mt-4">
          <div class="row p-3">
            ...
            <div
              class="col-lg-4 col-xl-4 col-md-4 col-sm-12 col-xs-12 mb-5  responsive-filter"
            ...
            >
              <div class="card border-0">
                ...
                <a
                  ...
                  style="text-decoration: none"
                >
                  <p class="mb-1 font-size-responsive">
                    <i class="fa fa-star" style="color: #f93b3b"></i>4,{{
                      Math.round(Math.random() * 20)
                    }}
                    ({{ Math.round(Math.random() * 20) }} değerlendirme)
                  </p>
             ...
             <div
              class="col-lg-4 col-xl-4 col-md-4 col-sm-12 col-xs-12 mb-5 responsive-filter2"
...
export default {
  ...
  methods: {
    ...
    mathRandom() {
      this.randomNumber = Math.round(Math.random() * 30);
      this.randomNumber2 = Math.ceil(Math.random() * 30);
      this.randomNumber3 = Math.ceil(Math.random() * 30);
    },
    getUserDATA() {
      return axios
        .get(
  ...
  font-size: 13px;"
        ...
        <div class="carousel-inner" style="border-radius: 20px 20px 0px 0px;cursor:pointer">
          <a class="carousel-item active" target="_blank" href="/homes/${
            marker.firebaseId
          }" style="cursor:pointer" >
            <img
      ...
      <div class="card-body mt-2"  style="cursor:pointer">
       <a href="/homes/${
         marker.firebaseId
       }" target="_blank" style="text-decoration:none" class="text-dark">
