          ...
          <div class="row">
            <div class="col-lg-6 col-ms-6 col-sm-12 col-xs-12">
              ...
              <div class="buttons mt-5">
                ...
                <button
                  :disabled="$v.home.promotion.$invalid || $v.home.title.$invalid"
                  class="btn btn-danger float-right"
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              ...
              <div class="buttons mt-4">
                ...
                >
                  Bitir <i class="far fa-arrow-alt-circle-right"></i>
                </button>
              </div>
            </div>
    ...
    getAdress() {
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition((position) => {
          this.home.position.lng = position.coords.longitude;
          this.home.position.lat = position.coords.latitude;
          axios
            .get(
